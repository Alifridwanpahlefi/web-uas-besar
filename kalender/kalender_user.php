...
<head>
  <meta charset="UTF-8">
  <title>Kalender Booking Saya</title>
  ...
  <style>
    ...
    .fc .fc-button {
      background: linear-gradient(90deg, #26a69a 60%, #80cbc4 100%) !important;
      color: #fff !important;
    ...
    .fc .fc-button:hover, .fc .fc-button:focus {
      background: linear-gradient(90deg, #009688 60%, #26a69a 100%) !important;
      color: #fff !important;
    }
...
<div class="container">
  <div class="glass-user mx-auto" style="max-width: 900px;">
    <h3 class="mb-4" style="color:#009688;font-weight:700;">Kalender Booking Saya</h3>
