...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($cek) > 0) {
        ...
        $ok = mysqli_query($conn, "INSERT INTO alif_pengguna (nama_pengguna, email, password, peran) VALUES ('$nama', '$email', '$password', '$peran')");
        if ($ok) {
...
<div class="container">
  <h2 class="page-title animate__animated animate__fadeInDown">Tambah User</h2>
  <div class="edit-user-card animate__animated animate__fadeInUp">
    ...
    <form method="post">
      ...
      <div class="d-flex justify-content-between">
        ...
        <button type="submit" class="btn btn-admin">Tambah User</button>
      </div>
    </form>
  </div>
</div>
