...
if (isset($_POST['tambah_lapangan'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO alif_lapangan (nama_lapangan, deskripsi, harga_per_jam) VALUES ('$nama_lapangan', '$deskripsi', '$harga_per_jam')");
    if ($query) {
...
$query_lapangan = mysqli_query($conn, "SELECT * FROM alif_lapangan");
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<nav class="navbar navbar-expand-lg navbar-light glass-admin shadow-sm sticky-top mb-4">
  <div class="container">
    ...
    <a class="navbar-brand" href="#">Kelola Lapangan</a>
    ...
    <div class="collapse navbar-collapse" id="navMenu">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link btn-glass-admin active" href="#">Lapangan</a></li>
...
<div class="container">
  <h2 class="dashboard-title">Kelola Lapangan Futsal</h2>
  <div class="glass-content-admin mb-4">
    ...
    <form method="POST">
      ...
      <button type="submit" name="tambah_lapangan" class="btn btn-success w-100">Tambah Lapangan</button>
    </form>
  </div>
  <div class="glass-content-admin">
    <h3 class="mb-4">Daftar Lapangan</h3>
    <div class="table-responsive">
      <table class="table table-bordered table-hover align-middle">
        ...
        <tbody>
          <?php $no = 1; while ($data = mysqli_fetch_assoc($query_lapangan)) : ?>
          <tr>
            <td><?= $no++ ?></td>
            ...
            <td>
              <a href="edit_lapangan.php?id=<?= $data['id_lapangan'] ?>" class="btn btn-warning btn-sm">Edit</a>
              <a href="hapus_lapangan.php?id=<?= $data['id_lapangan'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus lapangan ini?')">Hapus</a>
            </td>
          </tr>
          <?php endwhile; ?>
        </tbody>
